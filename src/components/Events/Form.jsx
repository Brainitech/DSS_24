  ...
  return (
    <>
      ...
      <div className="reg-form absolute flex-col bgg backdrop-blur-md rounded-2xl items-center overflow-hidden h-[80vh] cursor-none w-max md:w-[40vw] lg:w-[30vw]" style={{ display: `none` }}>
        ...
        <div
          className="form-loader absolute w-[200px] h-[200px] rounded-2xl bg-gray-500 bg-opacity-50 backdrop-blur-3xl top-[50%] flex-col justify-center items-center text-center font-bold text-white"
          style={{ display: `none` }}
        >
          <img src={Loader} />
        </div>
