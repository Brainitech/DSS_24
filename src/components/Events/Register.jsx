  ...
  if (animationIndex === 4) {
    return (
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="w-[300px] h-[300px] rounded-2xl bg-contain mb-8" style={{ backgroundImage: `url(${TQ})` }}></div>
        <button className="w-max text-white text-xl font-bold bg-purple-800 rounded-2xl px-4">Register Now!</button>
      </div>
    )
  }
  if (animationIndex === 3) {
    return (
      <div className="flex flex-col justify-center items-center">
        ...
        <div
          className="w-[300px] h-[300px] rounded-2xl bg-contain mb-8 bg-gray-700"
          style={
            {
              /* backgroundImage: `url(${HnF})` */
            }
          }
        ></div>
        <button className="w-max text-white text-xl font-bold bg-purple-800 rounded-2xl px-4">Register Now!</button>
  ...
  if (animationIndex === 2) {
    return (
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="w-[300px] h-[300px] rounded-2xl bg-contain mb-8" style={{ backgroundImage: `url(${TH})` }}></div>
        <button className="w-max text-white text-xl font-bold bg-purple-800 rounded-2xl px-4">Register Now!</button>
      </div>
    )
  }
  if (animationIndex === 1) {
    return (
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="w-[300px] h-[300px] rounded-2xl bg-contain mb-8" style={{ backgroundImage: `url(${CC})` }}></div>
        <button className="w-max text-white text-xl font-bold bg-purple-800 rounded-2xl px-4">Register Now!</button>
      </div>
    )
  }
