...
import img from "../Hero section/Model.png"
    ...
    <div className='bg-gradient-to-b from-black to-blue-900'>
        <div className="lg:px-4 px-10 lg:py-0 py-20 text-center gap-5 lg-text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center mb-8 ">
            <div className="h-full lg:py-20 ml-20 p-8 flex flex-col justify-center lg:items-start items-center text-white text-start">
                <h2 className="text-[54px] font-semibold mb-2 leading-loading text-blue-800 headingcontent text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-green-300">Data Science Summit'24</h2>
                <p className="mt-2 mb-8">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam pariatur excepturi rem molestiae temporibus sint doloribus suscipit. Eaque dignissimos eveniet veritatis consectetur officia. Iure accusantium illum tempore, minima dignissimos quia?</p>
              ...
              <input type="email" id="email" class="shadow-sm bg-gray-50 border text-black text-sm rounded-lg block " placeholder="name@gmail.com" required/>
        ...
        <div className='lg:mx-40 mx-10 lg:my-0 my-20 text-center gap-5 lg-text-start grid lg:grid-cols-2 grid-cols-1 lg:gap-28 items-center border-white border-2 rounded-xl p-20 bg-gradient-to-r from-purple-900 via-blue-950 to-black '>
            ...
            <p className="mt-2 text-[10px]">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam pariatur excepturi rem molestiae temporibus sint doloribus suscipit. Eaque dignissimos eveniet veritatis consectetur officia. Iure accusantium illum tempore, minima dignissimos quia?</p>
            ...
            <h2 className="text-[32px] font-semibold mb-8 leading-loading text-blue-800 text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-green-300 headingcontent1">2nd - 3rd Dec , 2024</h2>
            ...
            <ul className='grid grid-cols-4 gap-8 text-center text-[20px]'>
                <li className= 'bg-gradient-to-b from-blue-600 via-blue-900 to-purple-950 leading-tight rounded-[3px] px-2'>64<br />days</li>
                <li className='bg-gradient-to-b from-blue-600 via-blue-900 to-purple-950 leading-tight rounded-[3px]'>64<br />days</li>
                <li className='bg-gradient-to-b from-blue-600 via-blue-900 to-purple-950 leading-tight rounded-[3px]'>64<br />days</li>
                <li className='bg-gradient-to-b from-blue-600 via-blue-900 to-purple-950 leading-tight rounded-[3px]'>64<br />days</li>
            </ul>
            </div>
