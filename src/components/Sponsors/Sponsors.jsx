...
function Sponsors() {
  return (
    <div id="sponsors" className="p-4 flex flex-col justify-center text-center bg-gradient-to-b from-black via-purple-950 to-black pb-8 overflow-x-hidden">
      <h1 className="mt-14 text-[60px] font-semibold mb-0 leading-normal text-white">Sponsors</h1>
